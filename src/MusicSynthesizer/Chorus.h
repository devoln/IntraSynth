...
struct ChorusFactory
{
	...
	ChorusFactory(decltype(nullptr)=nullptr): MaxDelay(0), DelayFrequency(0), MainVolume(0), SecondaryVolume(0) {}
	...
	INTRA_FORCEINLINE bool operator==(decltype(nullptr)) const noexcept {return MaxDelay == 0 || SecondaryVolume == 0;}
